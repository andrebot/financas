export default {
  translation: {
    ...
    bankAccountBalances: 'Bank Account Balances',
    credit: 'Credit',
    expires: 'Expires',
    ...
    budgetCreationFailed: 'Failed to create budget! Please try again later.',
    budgetDeleted: 'Budget deleted successfully!',
    budgetDeletionFailed: 'Failed to delete budget! Please try again later.',
    budgetUpdated: 'Budget updated successfully!',
    budgetUpdateFailed: 'Failed to update budget! Please try again later.',
    startDateRequired: 'Start date is required',
    endDateRequired: 'End date is required',
    endDateMustBeAfterStartDate: 'End date must be after start date',
    typeRequired: 'Type is required',
    typeInvalid: 'Type is invalid',
    budgetCategoriesRequired: 'Categories are required for budget',
    budgetDeletedSuccessfully: 'Budget deleted successfully!',
    budgetDeletedError: 'Failed to delete budget! Please try again later.',
    deleteBudget: 'Delete Budget',
    deleteBudgetMessage: 'Are you sure you want to delete the selected budget?',
