export default {
  translation: {
    ...
    budgetCategories: 'Categorias do Orçamento',
    saveBudget: 'Salvar Orçamento',
    budgetCreated: 'Orçamento criado com sucesso!',
    budgetCreationFailed: 'Falha ao criar orçamento! Por favor, tente novamente mais tarde.',
    budgetDeleted: 'Orçamento deletado com sucesso!',
    budgetDeletionFailed: 'Falha ao deletar orçamento! Por favor, tente novamente mais tarde.',
    budgetUpdated: 'Orçamento atualizado com sucesso!',
    budgetUpdateFailed: 'Falha ao atualizar orçamento! Por favor, tente novamente mais tarde.',
    startDateRequired: 'Data de início é obrigatória',
    endDateRequired: 'Data de fim é obrigatória',
    endDateMustBeAfterStartDate: 'A data de fim deve ser após a data de início',
    typeRequired: 'Tipo é obrigatório',
    typeInvalid: 'Tipo inválido',
    budgetCategoriesRequired: 'Categorias são obrigatórias para o orçamento',
    budgetDeletedSuccessfully: 'Orçamento deletado com sucesso!',
    budgetDeletedError: 'Falha ao deletar orçamento! Por favor, tente novamente mais tarde.',
    deleteBudget: 'Deletar Orçamento',
    deleteBudgetMessage: 'Tem certeza que deseja deletar o orçamento selecionado?',
    noBudgets: 'Nenhum orçamento encontrado',
    value: 'Valor',
    dateFormat: 'ddd DD/MM/YYYY',
    withdraw: 'Retirada',
    transferIn: 'Recebimento de Transferência',
    transferOut: 'Trasnsferência',
    deposit: 'Deposito',
    bankSlip: 'Boleto',
    cardPurchase: 'Compra no Cartão',
    cardRefund: 'Reembolso no Cartão',
    investmentBuy: 'Compra de Investimento',
